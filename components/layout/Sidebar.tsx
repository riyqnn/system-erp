...
const getModuleNavigation = (activeModule?: string): MenuItem[] => {
  const moduleMenus: Record<string, MenuItem[]> = {
    ...
    purchasing: [
      { label: 'Dashboard', href: '/purchasing', icon: GridFour },
      { label: 'Suppliers', href: '/purchasing/suppliers', icon: Users },
      { label: 'Purchase Requisition', href: '/purchasing/purchase-requisition', icon: ClipboardText },
      { label: 'RFQ / Sourcing', href: '/purchasing/rfq-sourcing', icon: FileText },
      { label: 'Price Negotiation', href: '/purchasing/negotiation', icon: Handshake },
      { label: 'Purchase Order', href: '/purchasing/purchase-orders', icon: ShoppingCart },
      { label: 'Monitoring', href: '/purchasing/delivery-monitoring', icon: Truck },
      { label: 'Goods Receipt', href: '/purchasing/goods-receipt', icon: Package },
      { label: 'Three-Way Matching', href: '/purchasing/three-way-matching', icon: Scales },
    ],
    production: [
