...
const getModuleNavigation = (activeModule?: string): MenuItem[] => {
  const moduleMenus: Record<string, MenuItem[]> = {
    inventory: [
      ...
      { label: 'Categories', href: '/apps/inventory/categories', icon: Package },
      { label: 'Stock Operations', href: '/apps/inventory/stock', icon: Package },
      { label: 'Warehouses', href: '/apps/inventory/warehouses', icon: Package },
    ],
    finance: [
      { label: 'Overview', href: '/apps/finance', icon: SquaresFour },
    ...
    purchasing: [
      { label: 'Overview', href: '/apps/purchasing', icon: SquaresFour },
    ...
    production: [
      { label: 'Overview', href: '/apps/production', icon: SquaresFour },
    ...
    snm: [
      { label: 'Overview', href: '/apps/snm', icon: SquaresFour },
